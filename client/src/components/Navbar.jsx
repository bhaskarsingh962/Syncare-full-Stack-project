...
const Navbar = () => {
  ...
  return (
    <div className=' flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400 '>
        <img onClick={()=>{navigate('/')}} className=' w-44 cursor-pointer ' src={assets.logoWeb} alt='logo' />
        <ul className=' hidden md:flex items-start gap-5 font-medium ' >
            ...
            <NavLink to={'/doctors'}>
                ...
                <hr className='border-none  outline-none h-0.5 bg-[#5f6fff] bg-primary w-3/5 m-auto hidden' />
            </NavLink>
            <NavLink to={'/about'}>
